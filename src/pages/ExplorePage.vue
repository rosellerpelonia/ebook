  ...
  <MainLayout>
    <section class="explore-page">
      ...
      <div class="explore-page__inner">
        <section class="mx-auto mb-12 max-w-6xl px-4 pt-6 md:px-6">
          <div
            class="overflow-hidden rounded-[2rem] border border-white/10 bg-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.18)] backdrop-blur-xl">
            <div class="border-b border-white/10 px-6 py-5 md:px-8">
              <p
                class="text-center font-['Rethink_Sans'] text-sm font-semibold uppercase tracking-[0.3em] text-white/70">
                Explore Guide
              </p>
              <h2 class="mt-1 text-center font-['Helvetica'] text-xl font-semibold text-white md:text-2xl">
                Navigate by Section
              </h2>
            </div>

            <div class="flex flex-wrap justify-center gap-3 px-5 py-6 md:px-8 md:py-8">
              <button v-for="section in sections" :key="section.id" @click="scrollToSection(section.id)"
                class="group rounded-full border border-white/15 bg-white/10 px-5 py-3 font-['Rethink_Sans'] text-sm font-semibold text-white transition duration-300 hover:-translate-y-0.5 hover:bg-[#ffba2f] hover:text-black">
                <span class="flex items-center gap-2">
                  <span class="h-2 w-2 rounded-full bg-[#ffba2f] transition group-hover:bg-black"></span>
                  {{ section.label }}
                </span>
              </button>
            </div>
    ...
    <section id="ethics-ai-art" class="ethics-and-creativity scroll-mt-28">
      ...
      <section class="content-section">
        ...
        <img v-if="imageUrls.explore17" :src="imageUrls.explore17" alt="Contest winner ceremony"
          cclass="section-image cursor-zoom-in transition duration-300 hover:scale-[1.02]"
